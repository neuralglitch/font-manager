...
#[AsCommand(
    ...
    description: 'Migrate from neuralglitch/google-fonts to font-manager'
)]
final class MigrateFromGoogleFontsCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(
                <<<'HELP'
This command helps migrate from neuralglitch/google-fonts to font-manager.
...
HELP
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($dryRun) {
            ...
            $io->writeln('3. Run: composer remove neuralglitch/google-fonts');
